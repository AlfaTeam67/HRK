...
export interface paths {
    ...
    "/api/v1/customers/{customer_id}/ai-summary": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Get Ai Summary */
        post: operations["get_ai_summary_api_v1_customers__customer_id__ai_summary_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/customers/{customer_id}/ai-summary/stream": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Stream Ai Summary */
        get: operations["stream_ai_summary_api_v1_customers__customer_id__ai_summary_stream_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/documents/{id}/stream": {
        ...
        /** Stream Document */
        get: operations["stream_document_api_v1_documents__id__stream_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/gus/cpi": {
        ...
        /** Aktualny wskaźnik CPI z GUS BDL */
        get: operations["get_cpi_api_v1_gus_cpi_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/document-generations/templates": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List Templates */
        get: operations["list_templates_api_v1_document_generations_templates_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/document-generations/preview": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Preview Generation */
        post: operations["preview_generation_api_v1_document_generations_preview_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/document-generations/": {
        ...
        /** List Generations */
        get: operations["list_generations_api_v1_document_generations__get"];
        put?: never;
        /** Finalize generation — renders PDF (DRAFT) and persists snapshot */
        post: operations["create_generation_api_v1_document_generations__post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/document-generations/{generation_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Generation */
        get: operations["get_generation_api_v1_document_generations__generation_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/document-generations/{generation_id}/accept": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Accept the previewed PDF — removes DRAFT watermark and locks the document */
        post: operations["accept_generation_api_v1_document_generations__generation_id__accept_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/document-generations/{generation_id}/reject": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["reject_generation_api_v1_document_generations__generation_id__reject_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/document-generations/{generation_id}/draft-data": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        head?: never;
        /**
         * Edit AI-generated narrative before acceptance (cover letter, rationale, note)
         * @description Update editable narrative fields on a PREVIEW/DRAFT generation.
         *
         ...
         */
        patch: operations["update_draft_data_api_v1_document_generations__generation_id__draft_data_patch"];
        trace?: never;
    };
    "/api/v1/document-generations/{generation_id}/preview-html": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Re-render generation HTML (debug / iframe preview helper) */
        get: operations["get_generation_preview_html_api_v1_document_generations__generation_id__preview_html_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @description Lifecycle of an AI-assisted document generation.
         * @enum {string}
         */
        DocumentGenerationStatus: "draft" | "preview" | "finalized" | "accepted" | "sent" | "superseded" | "rejected";
        /** DocumentRead */
        DocumentRead: {
            /**
             * Id
         ...
         * @description Public description of a registered template — drives the wizard UI.
         */
        DocumentTemplateRead: {
            /** Key */
            key: string;
        ...
        /**
         * DocumentTone
         * @description Stylistic tone for AI-generated narrative parts (cover letter, rationale).
         * @enum {string}
         */
        DocumentTone: "formal" | "neutral" | "warm" | "assertive";
        /**
         * DocumentType
         * @enum {string}
         */
        DocumentType: "contract" | "amendment" | "power_of_attorney" | "DPA" | "PPK" | "report" | "cover_letter" | "other";
        /**
         * GenerationAccept
         * @description User confirms the previewed PDF is OK to use / send.
         */
        GenerationAccept: {
            /**
             * Accepted By
         ...
         * @description Editable narrative fields on a generation that is still in PREVIEW status.
         *
         ...
         * @description What the wizard step 3-4 needs to render the preview.
         */
        GenerationPreviewResponse: {
        ...
        /**
         * GenerationRead
         * @description Persisted generation record.
         */
        GenerationRead: {
            /**
             * Id
            ...
            /** Cover Letter Attachment Id */
            cover_letter_attachment_id: string | null;
            /** Template Key */
            template_key: string;
            /** Template Version */
            template_version: string;
            status: components["schemas"]["DocumentGenerationStatus"];
            /** Payload */
            payload: {
                [key: string]: unknown;
            };
        ...
        /**
         * GenerationRequest
         * @description Common request body for preview + finalize endpoints.
         */
        GenerationRequest: {
            /** Template Key */
            template_key: string;
            ...
            /** Contract Id */
            contract_id?: string | null;
            params: components["schemas"]["ValorizationParams"];
            /** User Instructions */
            user_instructions?: string | null;
            /** @default neutral */
            tone: components["schemas"]["DocumentTone"];
            /**
        ...
        /**
         * ServiceSimulation
         * @description Per-service computed financial impact of valorization.
         */
        ServiceSimulation: {
            /**
             * Contract Service Id
        ...
        /**
         * SimulationSummary
         * @description Roll-up totals across all services in scope.
         */
        SimulationSummary: {
            /** Services */
            services: components["schemas"]["ServiceSimulation"][];
            /** Current Annual Revenue */
            current_annual_revenue: string;
            /** Proposed Annual Revenue */
            proposed_annual_revenue: string;
            /** Delta Annual Revenue */
            delta_annual_revenue: string;
            /** Delta Annual Revenue Pct */
            delta_annual_revenue_pct: string;
            /** Weighted Avg Index Pct */
        ...
        TimelineEventRead: {
             ...
             * @enum {string}
             */
            event_type: "contract_signed" | "valorization_approved" | "valorization_started" | "note_added" | "meeting" | "call" | "email" | "document" | "verification" | "system" | "alert_triggered";
            /** Title */
            title: string;
            /** Detail */
            detail?: string | null;
        ...
        /**
         * ValorizationParams
         * @description Parameters for the ``amendment_valorization_v1`` template.
         */
        ValorizationParams: {
            /** Year */
            year: number;
            ...
            /** Services */
            services?: components["schemas"]["ValorizationServiceInput"][];
        };
        /**
         * ValorizationRead
         ...
         * @description Optional override for a single ContractService in the wizard.
         */
        ValorizationServiceInput: {
            /**
             * Contract Service Id
            ...
            include: boolean;
            /** Custom Index Pct */
            custom_index_pct?: number | string | null;
        };
        /**
         * ValorizationStatus
         * @enum {string}
...
export interface operations {
    ...
    get_ai_summary_api_v1_customers__customer_id__ai_summary_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    stream_ai_summary_api_v1_customers__customer_id__ai_summary_stream_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    stream_document_api_v1_documents__id__stream_get: {
        parameters: {
            query: {
                requester_user_id: string;
            };
    ...
    get_cpi_api_v1_gus_cpi_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GusCpiResponse"];
                };
            };
        };
    };
    list_templates_api_v1_document_generations_templates_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    preview_generation_api_v1_document_generations_preview_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    list_generations_api_v1_document_generations__get: {
        parameters: {
            query: {
                customer_id: string;
            };
    ...
    create_generation_api_v1_document_generations__post: {
        parameters: {
            query: {
    ...
    get_generation_api_v1_document_generations__generation_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    accept_generation_api_v1_document_generations__generation_id__accept_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["GenerationAccept"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    reject_generation_api_v1_document_generations__generation_id__reject_post: {
        parameters: {
            query: {
                rejected_by: string;
            };
    ...
    update_draft_data_api_v1_document_generations__generation_id__draft_data_patch: {
        parameters: {
            query: {
                /** @description UUID of the user making the edit */
                updated_by: string;
            };
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["GenerationDraftDataUpdate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_generation_preview_html_api_v1_document_generations__generation_id__preview_html_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_customer_timeline_api_v1_customers__customer_id__timeline_get: {
        parameters: {
            query?: {
                ...
                to_date?: string | null;
                event_types?: ("contract_signed" | "valorization_approved" | "valorization_started" | "note_added" | "meeting" | "call" | "email" | "document" | "verification" | "system" | "alert_triggered")[] | null;
                limit?: number;
            };
            header?: never;
            path: {
