...
//   {
//     type: 'urgent',
//     title: 'Empik – umowa kończy się za 28 dni',
//     detail: 'Umowa nr 000123/43 · data wypowiedzenia: 30 dni',
//   },
//   {
//     type: 'warning',
//     title: 'Waloryzacja po terminie – MediaMarkt',
//     detail: 'Planowana na 01.03.2026 · brak reakcji',
//   },
//   {
//     type: 'urgent',
//     title: 'TechNova – błąd w rozliczeniu PPK',
//     detail: 'Niezgodność składek dla 12 pracowników · wymagana korekta',
//   },
//   {
//     type: 'info',
//     title: 'Rossmann – brak kontaktu od 87 dni',
//     detail: 'Ostatni kontakt: 04.01.2026',
//   },
//   {
//     type: 'neutral',
//     title: 'Biedronka – waloryzacja za 14 dni',
//     detail: 'GUS inflacja: 4,5% · sugestia według gotowe',
//   },
//   {
//     type: 'warning',
//     title: 'Lidl – brak podpisanego aneksu nr 4',
//     detail: 'Wysłano 10.02.2026 · status: weryfikacja prawna',
//   },
//   {
//     type: 'info',
//     title: 'Nowe zapytanie – Carrefour',
//     detail: 'Klient pyta o rozszerzenie outsourcingu IT',
//   },
// ]
    ...
    ? [
        {
          ...
          value: String(kpiData.active_customers),
          trend: 'aktualne dane',
          trendUp: true,
        },
        {
          label: 'AKTYWNYCH UMÓW',
          value: String(kpiData.active_contracts),
          trend: `♦ ${kpiData.contracts_expiring_30d} kończy się w 30 dni`,
          trendUp: kpiData.contracts_expiring_30d === 0,
        },
        {
          label: 'WALORYZACJE DO ZROBIENIA',
          value: String(kpiData.valorizations_pending),
          trend: `⚡ ${kpiData.valorizations_overdue} po terminie`,
          trendUp: kpiData.valorizations_overdue === 0,
        },
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <Modal
        ...
        title="Generuj aneks do umowy"
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <label style={{ fontSize: 12, fontWeight: 700, color: '#4a4340' }}>
              Wybierz klienta
            </label>
            <select
              style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              <label style={{ fontSize: 12, fontWeight: 700, color: '#4a4340' }}>
                Nowa stawka (opcjonalnie)
              </label>
              <input
                type="text"
                placeholder="np. 4500 PLN"
                style={{
                  padding: '8px 12px',
                  borderRadius: 6,
                  border: '1px solid #e3e0db',
          ...
          >
            <div style={{ fontSize: 11, fontWeight: 700, color: '#e85c04', marginBottom: 4 }}>
              💡 Podpowiedź AI
            </div>
            <div style={{ fontSize: 11, color: '#6b6b6b', lineHeight: 1.4 }}>
              Dla klienta Empik sugerowana waloryzacja wynosi <strong>4.8%</strong> (zgodnie z
              komunikatem GUS ze stycznia).
            </div>
          </div>
      ...
      >
        {kpis.map((kpi) => (
          <div key={kpi.label} style={{ ...card, padding: '16px 18px' }}>
            ...
            <div style={{ fontSize: 11, color: kpi.trendUp ? '#38a169' : '#e85c04' }}>
              {kpi.trend}
            </div>
          </div>
        ))}
        ...
        <div>
            ...
            {realAlerts === undefined ? (
              ...
              alerts.map((a, index) => (
                <div key={`${a.type}-${a.title}-${a.detail}-${index}`} style={ALERT_STYLE[a.type]}>
                  <div style={{ fontSize: 13, fontWeight: 600, color: '#1a1714', marginBottom: 2 }}>
                    {a.title}
                  </div>
          ...
          <div style={{ ...card, padding: '16px 18px' }}>
            ...
            >
              ...
              <span style={{ fontSize: 12, color: '#e85c04', cursor: 'pointer', fontWeight: 600 }}>
                Zobacz wszystkie
              </span>
            </div>
        ...
        <div>
          <div style={{ ...card, padding: '16px 18px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span
                      style={{
                        ...
                        height: 6,
                        borderRadius: '50%',
                        background: item.type === 'good' ? '#38a169' : '#e85c04',
                        flexShrink: 0,
            ...
            >
              ...
              >
                <svg width="11" height="11" viewBox="0 0 24 24" fill="#c94f02">
