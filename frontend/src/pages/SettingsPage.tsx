...
const ROLES_REFERENCE = [
  {
    ...ALL_ROLES[0],
    permissions: ['Wszystkie zasoby (pełny dostęp)', 'Zarządzanie użytkownikami', 'Zatwierdzanie waloryzacji', 'Konfiguracja systemu'],
  },
  {
    ...ALL_ROLES[1],
...
export function SettingsPage() {
  ...
  const kpis = [
    { label: 'UŻYTKOWNICY',    value: usersLoading ? '…' : String(totalUsers),  sub: `${totalUsers} w systemie`,  color: '#3182ce' },
    { label: 'ROLE SYSTEMOWE', value: '5',                                       sub: 'Przypisywane przez AD',     color: '#6b3fa0' },
    ...
    <div style={{ width: '100%' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
        <div>
          ...
          <p style={{ fontSize: 12.5, color: '#9e9389', margin: 0 }}>Role użytkowników są pobierane automatycznie z Active Directory przy logowaniu.</p>
        </div>
        {isAdmin && (
          <button
